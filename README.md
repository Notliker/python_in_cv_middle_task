...
В рамках данной задачи Вам необходимо продолжить работу с датасетом (см. Лекция 2): https://disk.yandex.ru/d/GEuRLrcb5-_pqA

В рамках реализации задачи Вам необходимо реализовать следующие модули:
 - кодировщик
 - кластеризатор
 - *оптимизатор гиперпараметров

Модуль "кодировщик" предоставляет функционал для перекодировки изображения. Вам необходимо реализовать алгоритм (для каждого изображения), включающий следующие шаги:
 ...
 В рамках данной реализации Вам необходимо реализовать алгоритм Нечетких c-средних.
 Параметры алгоритма:
 ...
 Алгоритм:
  ...
  - 3.1 Вычислить центроид для каждого кластера.
  - 3.2 Для каждой точки данных вычислить коэффициент принадлежности к кластерам.
...
![alt text](image.png)
m = 2 - начальный выбор 
Функция расстояния: L1 (сумма модулей разностей).
...
Выходные данные:
 ...
 Каждый модуль реализовать в виде плагина с динамической загрузкой модулей (см. Лекция 5).
 Реализовать тестовый скриптор, демонстрирующий результат работы реализованного функционал на выбранном наборе данных.
 Для ускорения тестового демо возможно сделать подвыборку исходных данных из 20-100 изображений.
